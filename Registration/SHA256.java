...
public class SHA256 {
    ...
    // Hashing constants declarations
    ...
    // Constants representing first 32 bits of the fractional parts of the square roots of the first 8 primes: 2, 3, 5, 7, 11, 13, 17, 19
    ...
    private static int[] pad(byte[] message) {
        ...
        // new message length: original + 1-bit and padding + 8-byte length --> block count: whole blocks + (padding + length rounded up)
